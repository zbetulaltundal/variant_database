select gene_name,AC,variant_aa_change,source_db_id,consequence_type from variant limit 10;
clinical_significance,phenotype_disease,phenotype_disease_source,cytogenetic_band,chromosome_coordinate,ensembl_gene_ID,ensembl_transcript_ID,ensembl_translation_ID from variant;
